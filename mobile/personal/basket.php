...
$APPLICATION->SetTitle("");?><?$APPLICATION->IncludeComponent("bitrix:sale.basket.basket", "basket-tovar", Array(
	"ACTION_VARIABLE" => "basketAction",	// Название переменной действия
		...
		"PATH_TO_ORDER" => "/mobile/personal/order/",	// Страница оформления заказа
